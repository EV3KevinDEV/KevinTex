...
- **Ubuntu:** `kevintex_1.2.9_all.deb`
- **Windows:** portable `KevinTex-1.2.9-windows-x64.zip` containing `KevinTex.exe`
- **Windows GPU:** `KevinTex-1.2.9-windows-x64-cuda.7z.001` or
  `KevinTex-1.2.9-windows-x64-vulkan.zip`
- **Apple Silicon macOS:** `KevinTex-1.2.9-macOS-arm64.dmg` or `.zip`
...
sudo apt install ./dist/kevintex_1.2.9_all.deb
```
